...
TAT will not connect to the internet. TAT will not cover data privacy concerns beyond what is currently used in standard teaching practices in Geneva, see section \ref{data_privacy}.
...
\begin{figure}[!hbtp] \label{inheritance_diagram_Buttons}
\begin{center}
...
\end{tikzpicture}
\end{center}
\caption{Inheritance diagram for the objects modelling the Buttons in the GUI.}
\end{figure}


\begin{figure}[!hbtp] \label{inheritance_diagram_Desks}
\begin{center}
\begin{tikzpicture}[node distance=18mm, every node/.style={draw, rectangle, rounded corners, text centered, minimum height=10mm, align=center, font=\fontsize{8}{10}\selectfont}]
...
\bibitem[Rowe72]{Rowe72} Rowe, M. B. (1972). Wait-Time and Rewards as Instructional Variables: Their Influence on Language, Logic, and Fate Control.
